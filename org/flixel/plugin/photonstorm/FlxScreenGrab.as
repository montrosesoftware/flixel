...
package org.flixel.plugin.photonstorm
{
	...
	public class FlxScreenGrab extends FlxBasic
	{
		 ...
		 */
		public static function grab(captureRegion:Rectangle = null, saveToFile:Boolean = false, hideMouse:Boolean = false, bitmap:IBitmapDrawable=null):Bitmap
		{
			...
			theBitmap.bitmapData.draw(bitmap == null ? FlxG.stage : bitmap, m);
